...
namespace Project1
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IFollowerRelationshipService, FollowerRelationshipService>();
            services.AddScoped<IFollowedRelationshipService, FollowedRelationshipService>();
